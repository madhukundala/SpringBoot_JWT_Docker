...
import com.test.jwt.ownApp.security.CustomUserDetailsService;
import com.test.jwt.ownApp.security.JwtAuthenticationEntryPoint;
import com.test.jwt.ownApp.security.JwtAuthenticationFilter;
	 ...
	 @Autowired
	  ...
	  @Override
	    protected void configure(HttpSecurity http) throws Exception {
	    	System.out.println("configureconfigure::::: "+http.toString());
	        http
	                .cors()
	                    .and()
	                .csrf()
